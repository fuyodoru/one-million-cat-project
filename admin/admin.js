        ...
        <div class="sighting-content">
            ...
            ${
                photoUrl
                    ...
                    : `
                        ...
                        <div class="sighting-photo no-photo">
            ...
            <div class="sighting-main">
                ...
                <div class="sighting-topline">
                    ...
                    <span
                        class="status-badge status-${escapeHTML(sighting.status)}"
                    >
...
function updateSectionDescription() {
    ...
    const descriptions = {
        ...
        pending:
            "PENDING SIGHTINGS WAITING FOR MODERATION.",

        approved:
            "SIGHTINGS CURRENTLY VISIBLE ON THE PUBLIC TRACKER.",

        rejected:
            "SIGHTINGS THAT HAVE BEEN REJECTED."
